ROM pytorch/pytorch:1.6.0-cuda10.1-cudnn7-devel 
...
#CMD python -m torch.distributed.launch --nproc_per_node=1 --nnodes=1 --node_rank=0 train.py ctc_config_ph4.yaml 
